window.modules["youtube.client"] = [function(require,module,exports){'use strict';

var youtubeVideoPlayer = require(211),
...
module.exports = function (el) {
  ...
  document.addEventListener('player-start-' + videoConfig.videoContainerId, function (evt) {
    ...
    if (hasChanged) {
      updateElementAttributes(el, evt.player); // this will tell the gtm.video trigger to stop ignoring gtm.video events
