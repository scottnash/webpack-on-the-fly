window.modules["978"] = [function(require,module,exports){'use strict';
    ...
    Container.prototype.normalize = function normalize(nodes, sample) {
        ...
        if (typeof nodes === 'string') {
            ...
            if (nodes.type === 'root') {
                ...
                var Rule = require(983);
                nodes = [new Rule(nodes)];
            } else if (nodes.name) {
                var AtRule = require(976);
...
}, {"976":976,"977":977,"979":979,"980":980,"981":981,"982":982,"983":983,"984":984}];
