window.modules["1019"] = [function(require,module,exports){'use strict';
    ...
    Container.prototype.normalize = function normalize(nodes, sample) {
        ...
        if (typeof nodes === 'string') {
            ...
            if (nodes.type === 'root') {
                ...
                var Rule = require(1024);
                nodes = [new Rule(nodes)];
            } else if (nodes.name) {
                var AtRule = require(1017);
...
}, {"1017":1017,"1018":1018,"1020":1020,"1021":1021,"1022":1022,"1023":1023,"1024":1024,"1025":1025}];
