window.modules["column-subscribe.client"] = [function(require,module,exports){'use strict';

var dom = require(1),
    _kebabCase = require(70),
    _set = require(87),
    cmptName = 'column-subscribe';
...
DS.controller(cmptName, ['$window', function ($window) {
  ...
  function Constructor(el) {
    ...
    this.newsletterId = dom.find('.newsletterId').value;
  ...
  Constructor.prototype = {
    ...
    onSuccess: function onSuccess() {
      var successMsg = this.form.getAttribute('data-success-msg');
