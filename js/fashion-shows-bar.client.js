window.modules["fashion-shows-bar.client"] = [function(require,module,exports){'use strict';
...
DS.controller('fashion-shows-bar', [function () {
  function Constructor(el) {
    var articlesEl = el.querySelector('.shows'),
        articlesWrapperEl = el.querySelector('.shows-wrapper'),
        articles = el.querySelectorAll('.show'),
        currentSlide = 0,
        animating = false,
        hammertime,
